 ...
 <div class="modal-card windows-agent-dialog" role="dialog" aria-modal="true">
  ...
  <div class="windows-agent-body">
    <div class="agent-onboarding">
      ...
      <div class="actions"><button class="primary operate-only" type="button" onclick="pullAllWindowsAgentsNow()">⟳ Pull All Online</button><button class="secondary admin-only" type="button" onclick="downloadWindowsAgentPackage()">↓ Download Agent</button><button class="primary admin-only" type="button" onclick="createWindowsAgentEnrollment()">＋ Create Enrollment Token</button></div>
    </div>
...
async function pullAllWindowsAgentsNow(){
 ...
 if(!targets.length){alert('No online Windows Agent v1.1.0+ endpoints are available. Update older agents if needed.');return}
