...
</style></head><body><div class="shell"><aside class="side"><div class="brand">__EYE_LOGO__<b>GODSEYE</b><div class="muted">LOCAL NETWORK INTELLIGENCE</div></div><nav class="nav"><a href="/#overview">⌂ &nbsp; Dashboard</a><a class="active" href="/#devices">▣ &nbsp; Devices</a><a href="/#network">⌘ &nbsp; Network Map</a><a href="/#monitoring">◷ &nbsp; Monitoring</a><a href="/#findings">! &nbsp; Findings</a><a href="/#tools">⌁ &nbsp; Tools</a><a href="/#integrations">⌘ &nbsp; Integrations</a><a href="/#reports">▤ &nbsp; Reports</a><a href="/#security">⚙ &nbsp; Settings</a></nav></aside><main class="main"><header class="top"><span class="online">● Online</span><span id="who">admin</span></header><div class="wrap"><a class="back" href="/#devices">← Back to Devices</a><div class="hero"><div><h1 id="title">Device</h1><div class="muted" id="subtitle">Loading device intelligence…</div></div><div class="actions"><button class="btn" id="renameBtn" onclick="renameCurrentDevice()">Rename Device</button><span class="status" id="state">Loading</span></div></div><div id="content"><div class="panel"><div class="empty">Loading device intelligence…</div></div></div></div></main></div><script>
