...
document.addEventListener('keydown',e=>{if(e.key!=='Escape')return;const dm=document.getElementById('deviceModal');const mm=document.getElementById('monitorModal');if(mm&&mm.style.display!=='none'){closeMonitorEditor();return}if(dm&&dm.style.display!=='none'){closeAddDevice();return}});
</script></body></html>'''
