...
app = FastAPI(title="GODSEYE", version="2.6.0", lifespan=lifespan)
...
<div id="authOverlay" class="overlay" style="display:none">
  ...
  <div class="login-scene-footer">GODSEYE v2.6.0<br>Network Intelligence · Device Correlation · Smart Alerts</div>
</div>
...
function mapDeviceIconSrc(n){if(n&&n.icon_data)return n.icon_data;const key=mapDeviceIconKey(n);return key==='internet'?'':('/assets/device-icons/'+key+'.svg')}
