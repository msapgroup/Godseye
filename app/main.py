...
<section class="cyber-tool-card-grid" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));gap:12px;margin-bottom:18px">
<div class="cyber-tool-card" style="display:flex;align-items:center;gap:12px;padding:14px;border:1px solid var(--line,#29435b);border-radius:10px;background:var(--panel,#101923)"><div class="cyber-tool-card-icon" style="font-weight:800;color:#58b7ff;min-width:28px;text-align:center">⌁</div><div><h3>Nmap Discovery</h3><p>Find authorized hosts and exposed services on private networks.</p><span class="cyber-tool-status ready" style="display:block;color:#57c98a;font-size:11px;margin-top:6px">Available</span></div><button class="primary" onclick="runCyberNmap()">Run</button></div>
...
<div class="cyber-tool-card"><div class="cyber-tool-card-icon">✓</div><div><h3>Linux Hardening / YARA</h3><p>Planned read-only integrations for Lynis audits and YARA malware rules.</p><span class="cyber-tool-status planned" style="display:block;color:#e5b85c;font-size:11px;margin-top:6px">Planned</span></div><button class="secondary" disabled>Not installed</button></div>
</section>
