...
<div id="windowsAgentModal" class="modal" style="display:none" onclick="if(event.target===this)closeWindowsAgentModal()">
 <div class="modal-card windows-agent-dialog" role="dialog" aria-modal="true">
  ...
  <div class="windows-agent-body">
    ...
    <div id="windowsAgentPackageStatus" class="calendar-integration-note">Checking Agent 2.4.0 installer availability…</div>
...
<div class="hero remote-hero"><div><h1>Remote Access</h1><div class="muted">Quick Assist-style support for GODSEYE Windows Agent 2.4.0 or newer. Screen sharing and remote control require separate approval.</div></div><div class="remote-stats"><span><b id="remoteOnlineCount">0</b> Online</span><span><b id="remoteOfflineCount">0</b> Offline</span><span><b id="remoteTotalCount">0</b> Agents</span></div></div>
