...
<title>GODSEYE — Network Tools</title><script>(function(){try{const saved=localStorage.getItem('godseye_theme');const dark=saved==='dark'||(!saved&&window.matchMedia&&window.matchMedia('(prefers-color-scheme: dark)').matches);document.documentElement.dataset.theme=dark?'dark':'light'}catch(e){document.documentElement.dataset.theme='light'}})();</script>
<style>
...
<div class="hero"><div><h1>Integrations</h1><div class="muted">Manage multiple Pi-hole, UniFi and SNMP collectors from one place.</div></div><div class="actions"><a class="secondary" href="/metrics" target="_blank" style="text-decoration:none">Prometheus Metrics</a><button class="primary admin-only" onclick="openIntegrationModal()">+ Add Integration</button></div></div>
...
<section class="panel traffic-collection-panel">
<div class="table-head traffic-collection-head"><div class="traffic-title-row"><div class="traffic-title-icon">⇅</div><div><h2>Per-Device Traffic Collection</h2><div class="muted">Measure real device usage from the source that can actually see the traffic.</div></div></div><span id="trafficCollectionState" class="traffic-state">LOADING</span></div>
<div class="traffic-summary-grid">
<div class="traffic-summary-card"><div class="k">Active Source</div><div class="v" id="trafficSourceLabel">—</div><div class="sub" id="trafficSourceSub">Not configured</div></div>
<div class="traffic-summary-card"><div class="k">24h Download</div><div class="v" id="traffic24Rx">0 B</div><div class="sub">Measured per-device traffic</div></div>
<div class="traffic-summary-card"><div class="k">24h Upload</div><div class="v" id="traffic24Tx">0 B</div><div class="sub">Measured per-device traffic</div></div>
<div class="traffic-summary-card"><div class="k">Devices Measured</div><div class="v" id="trafficDeviceCount">0</div><div class="sub" id="trafficLastSample">No samples yet</div></div>
</div>
<div class="traffic-setup">
<div class="traffic-section-label">1. Choose traffic source</div>
...
<button type="button" class="traffic-source-card" data-traffic-mode="unifi" onclick="selectTrafficMode('unifi')">
  <div class="traffic-source-top"><span class="traffic-source-icon">◉</span><span class="traffic-source-kind">CONTROLLER API</span><span class="traffic-selected-check">✓</span></div>
  <div class="traffic-source-name">UniFi / Controller</div>
  <div class="traffic-source-desc">Use per-client byte counters already measured by your UniFi controller.</div>
  <div class="traffic-source-divider"></div>
  <div class="traffic-source-meta"><span><b>Best for</b> UniFi networks</span><span><b>Setup</b> Select integration</span></div>
  <div class="traffic-source-foot"><span class="traffic-source-tag recommended">Recommended</span><span>Low Pi overhead</span></div>
</button>
<button type="button" class="traffic-source-card" data-traffic-mode="snmp" onclick="selectTrafficMode('snmp')">
  <div class="traffic-source-top"><span class="traffic-source-icon">⌁</span><span class="traffic-source-kind">COUNTER PROFILE</span><span class="traffic-selected-check">✓</span></div>
  <div class="traffic-source-name">SNMP</div>
  <div class="traffic-source-desc">Collect mapped traffic counters from supported routers and managed switches.</div>
  <div class="traffic-source-divider"></div>
  <div class="traffic-source-meta"><span><b>Best for</b> Managed networks</span><span><b>Setup</b> Integration + OIDs</span></div>
  <div class="traffic-source-foot"><span class="traffic-source-tag">Flexible</span><span>Profile required</span></div>
</button>
<button type="button" class="traffic-source-card" data-traffic-mode="span" onclick="selectTrafficMode('span')">
  <div class="traffic-source-top"><span class="traffic-source-icon">⇄</span><span class="traffic-source-kind">PACKET SENSOR</span><span class="traffic-selected-check">✓</span></div>
  <div class="traffic-source-name">SPAN / Mirror</div>
  <div class="traffic-source-desc">Observe mirrored switch traffic without placing GODSEYE inline with the network.</div>
  <div class="traffic-source-divider"></div>
  <div class="traffic-source-meta"><span><b>Best for</b> Passive visibility</span><span><b>Setup</b> Mirror port + NIC</span></div>
  <div class="traffic-source-foot"><span class="traffic-source-tag advanced">Advanced</span><span>No gateway change</span></div>
</button>
<button type="button" class="traffic-source-card" data-traffic-mode="inline" onclick="selectTrafficMode('inline')">
  <div class="traffic-source-top"><span class="traffic-source-icon">↔</span><span class="traffic-source-kind">INLINE SENSOR</span><span class="traffic-selected-check">✓</span></div>
  <div class="traffic-source-name">Inline / Gateway</div>
  <div class="traffic-source-desc">Measure traffic that physically traverses the GODSEYE Raspberry Pi.</div>
  <div class="traffic-source-divider"></div>
  <div class="traffic-source-meta"><span><b>Best for</b> Full measurement</span><span><b>Setup</b> Inline network path</span></div>
  <div class="traffic-source-foot"><span class="traffic-source-tag advanced">Advanced</span><span>Highest visibility</span></div>
</button>
</div>
<div class="traffic-config-shell">
<div class="traffic-config-card"><div class="traffic-section-label">2. Configure source</div><div class="traffic-config-grid">
...
</div><div class="traffic-config-actions"><button class="primary" data-admin-only onclick="saveTrafficCollection()">Save Configuration</button><button class="secondary" data-admin-only onclick="collectTrafficNow()">Run Collection Now</button><span class="muted" id="trafficCollectionMeta"></span></div></div>
<div class="traffic-help-card"><div class="traffic-help-title"><span>ⓘ</span><span id="trafficModeHelpTitle">Source requirements</span></div><div id="trafficModeHelp" class="traffic-help-copy">Select a traffic source to see its requirements.</div><div id="trafficModeRequire" class="traffic-help-require">GODSEYE records the measurement source and confidence with every device sample.</div></div>
</div>
</div>
<div class="traffic-usage-head"><div><h3>Top Device Usage · Last 24 Hours</h3><div class="muted">Only measured per-device counters are shown here.</div></div><button class="secondary" onclick="loadReports()">↻ Refresh</button></div>
...
<section class="report-section-card"><div class="report-section-head"><div class="report-section-title"><span class="report-section-icon">⇩</span><div><h2>Report History</h2><div class="muted">Generated reports and export formats</div></div></div></div><div class="report-history-wrap"><table><thead><tr><th>Generated</th><th>Type</th><th>Title</th><th>Key Metrics</th><th>Export</th></tr></thead><tbody id="reportHistory"></tbody></table></div></section>
</div>
</div>
...
function applyRoleVisibility(){document.querySelectorAll('.admin-only').forEach(el=>el.classList.toggle('admin-visible',!!ME&&ME.role==='admin'))}
