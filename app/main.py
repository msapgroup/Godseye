...
DEFAULT_WINDOWS_AGENT_SETUP_FILENAME = "GODSEYE-Windows-Agent-x64-Setup.exe"
...
def windows_agent_package(user=Depends(require_admin)):
    ...
    filename=manifest.get("setup_filename") or DEFAULT_WINDOWS_AGENT_SETUP_FILENAME
...
/* consent-aware Windows Agent Remote Access */
