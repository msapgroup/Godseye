...
<script>
async function req(u,o){let r=await fetch(u,o);let t=await r.text();if(!r.ok)throw Error(t);return t?JSON.parse(t):{}}
...
<script>
async function req(url,opt){let r=await fetch(url,opt);let t=await r.text();if(!r.ok)throw new Error(t);return JSON.parse(t)}
...
<button class="navitem active" data-view="overview" onclick="showView('overview')">📡 <span>Dashboard</span></button>
<button class="navitem" data-view="activity" onclick="showView('activity')">🕓 <span>Activity</span></button>

<div class="navsection">Devices</div>
<button class="navitem" data-view="overview" onclick="showView('overview');document.getElementById('search').focus()">💻 <span>All Devices</span></button>
<button class="navitem" data-view="overview" onclick="showView('overview');status.value='online';loadDevices()">🟢 <span>Online Devices</span></button>
<button class="navitem" data-view="overview" onclick="showView('overview');status.value='offline';loadDevices()">⚫ <span>Offline Devices</span></button>
<button class="navitem" data-view="overview" onclick="showView('overview');classification.value='new';loadDevices()">⚠ <span>Needs Review</span><span class="badge" id="needsReviewBadge">0</span></button>

<div class="navsection">Discovery</div>
<a class="navitem" href="/tools#nmap">🔎 <span>Nmap Scan</span></a>
<a class="navitem" href="/tools#neighbors">📡 <span>Neighbors</span></a>
<a class="navitem" href="/tools#hostname">🔍 <span>DNS / Hostname</span></a>
<a class="navitem" href="/tools#discovery">🛰 <span>Discovery Tools</span></a>

<div class="navsection">Diagnostics</div>
<a class="navitem" href="/tools#diagnostics">🩺 <span>Diagnostics</span></a>
<a class="navitem" href="/tools#gateway">🌐 <span>Gateway / Internet</span></a>
<a class="navitem" href="/monitoring">🔗 <span>Service Monitor</span></a>
<a class="navitem" href="/tools#ask">🧠 <span>Ask GODSEYE</span></a>

<div class="navsection">Integrations</div>
<a class="navitem" href="/monitoring">🛡 <span>Pi-hole</span></a>
<a class="navitem" href="/monitoring">📶 <span>UniFi</span></a>
<a class="navitem" href="/monitoring">📊 <span>SNMP</span></a>
<a class="navitem" href="/monitoring">📋 <span>DHCP</span></a>

<div class="navsection">Tools</div>
<a class="navitem" href="/tools#wol">⚡ <span>Wake-on-LAN</span></a>
<a class="navitem" href="/monitoring">🌐 <span>Website Monitor</span></a>
<a class="navitem" href="/tools#speed">🚀 <span>Speed / Internet</span></a>

<div class="navsection">Alerts & System</div>
<button class="navitem" data-view="rules" id="navRules" onclick="showView('rules')">🚨 <span>Alert Rules</span></button>
<button class="navitem" data-view="security" onclick="showView('security')">🔒 <span>Security / MFA</span></button>
...
<a class="navitem" href="/tools#plugins">🧩 <span>Plugins</span></a>
</div>
