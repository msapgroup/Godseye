...
## UI cleanup
The legacy device modal was removed from the rendered document. This prevents the prior Device Intelligence block from appearing formatted at the bottom of pages. The interaction pattern uses GODSEYE's compact, operator-focused network-management UI.
