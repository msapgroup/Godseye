...
- Windows Agent source: **2.2.12 x64**; download the current guided installer from **Event Findings → Windows Agents** or the verified [Windows Agent releases](https://github.com/msapgroup/Godseye/releases)
