...
runuser -u "$APP_USER" -- env PYTHONPATH="$INSTALL_DIR" GODSEYE_DB="$DATA_DIR/godseye.db" GODSEYE_DATA_DIR="$DATA_DIR" "$INSTALL_DIR/.venv/bin/python" -c 'from app.main import app; print("GODSEYE application import / migration: PASS")'
