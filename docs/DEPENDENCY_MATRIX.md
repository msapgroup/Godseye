...
The broader plugin manifest contains planned GODSEYE capability entries. A manifest entry is not treated as proof that a third-party connector is production-complete; those connectors must be implemented and tested separately.
