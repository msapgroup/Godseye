...
> **v4.18 recommendation:** Use the GODSEYE Windows Agent for most computers and servers. It avoids inbound WinRM and pushes selected events outbound over HTTPS. WinRM remains an agentless fallback. See `WINDOWS_AGENT.md`.
