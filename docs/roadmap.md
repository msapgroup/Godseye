...
- Persistent monitoring collector manager
- Website, DHCP lease, Pi-hole, UniFi, SNMP and public-IP monitor types
- Monitoring results persisted in SQLite
- Authenticated monitoring management page
