...
def test_v35_version_and_ui_contract():
    ...
    assert Path("VERSION").read_text().strip().startswith(("3.5.0-", "3.6.0-", "3.7.0-", "3.8.0-", "3.9.0-", "4.0.0-", "4.1.0-", "4.2.0-", "4.3.0-", "4.4.0-", "4.5.0-", "4.6.0-", "4.7.0-", "4.8.0-", "4.9.0-", "4.10.0-", "4.10.1-", "4.11.0-", "4.12.0-"))
    html = main.DASHBOARD
