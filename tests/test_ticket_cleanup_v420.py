...
def test_version_v420():
    assert Path('VERSION').read_text().strip() in ('4.20.0-event-ticket-cleanup','4.21.0-ticket-assignee-picker','4.22.0-windows-agent-pull-now','4.22.1-windows-agent-upgrade-hotfix','4.23.0-permanent-x64-windows-agent','4.28.0-clean-rebuild')
