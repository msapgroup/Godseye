...
def test_version_v422():
    assert Path("VERSION").read_text().strip() in {"4.22.0-windows-agent-pull-now","4.22.1-windows-agent-upgrade-hotfix","4.23.0-permanent-x64-windows-agent","4.24.0","4.25.0"}
