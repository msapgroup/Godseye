...
def test_version_is_v26_or_later():
    assert Path("VERSION").read_text().strip().startswith(("2.6.0-", "2.7.0-", "2.8.0-", "2.9.0-", "3.0.0-", "3.1.0-", "3.2.0-", "3.3.0-", "3.4.0-", "3.5.0-", "3.6.0-", "3.7.0-", "3.8.0-", "3.9.0-", "4.0.0-", "4.1.0-", "4.2.0-", "4.3.0-", "4.4.0-", "4.5.0-", "4.6.0-", "4.7.0-", "4.8.0-", "4.9.0-", "4.10.0-", "4.10.1-", "4.11.0-", "4.12.0-", "4.13.0-", "4.14.0-", "4.15.0-", "4.16.0-"))
