...
def test_version():
    assert Path("VERSION").read_text().strip().startswith(("4.10.1-","4.11.0-", "4.12.0-", "4.13.0-", "4.14.0-", "4.15.0-", "4.16.0-", "4.17.0-", "4.18.0-", "4.19.0-", "4.20.0-", "4.21.0-", "4.22.0-", "4.22.1-", "4.23.0-", '4.28.0-'))
